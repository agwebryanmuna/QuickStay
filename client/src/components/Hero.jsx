...
const Hero = () => {
  ...
  const onSearch = async (e) => {
    ...
    await axios.post('/api/users/store-recent-search', { recentSearchedCities: destination }, { headers: { Authorization: `Bearer ${await getToken()}` } })
  ...
  return (
    <div
      ...
      <h1
        className="font-playfair text-2xl md:text-5xl md:text-[56px] md:leading-[56px] font-bold md:font-extrabold max-w-xl mt-4">
